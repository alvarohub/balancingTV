...
//------------------------------------------------------------
void pointMass::addInterBlobForce(float x, float y, float radius, float scale){
...
//------------------------------------------------------------
void pointMass::addInterParticleForce(pointMass &theOtherParticle, float radius, float scale){
